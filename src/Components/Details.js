...
import { faCheckToSlot, faPenToSquare, faTrash, faXmarkSquare } from '@fortawesome/free-solid-svg-icons'
              ...
              {editMode ?
                ...
                : <>
                  ...
                  <span className="icon" onClick={handleDelete} >
                    <FontAwesomeIcon className="Delete" icon={faTrash} color="black" />
                    <FontAwesomeIcon icon="fa-light fa-trash" />
                  </span>
                </>}
            </div>
